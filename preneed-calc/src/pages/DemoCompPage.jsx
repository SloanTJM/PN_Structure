...
const ALL_ADVANTAGES = [
  ...
  { key: 'income2',     roles: ['setter'],                      title: 'Two Income Streams', text: 'Earn a guaranteed base wage ($18/hr) plus a commission split on every deal that closes from your appointments. Income grows as you book more.' },
  { key: 'pipeline',    roles: ['closer', 'setter', 'aftercare'], title: 'Untapped Lead Pipeline', text: 'Over 30,000 contacts in our vault from 13 funeral homes and 3 cemeteries. Plus new leads from tradeshow marketing, outbound initiatives, mailouts, and digital marketing. No recycled leads, no burned territory.' },
